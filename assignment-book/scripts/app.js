...
(
    ...
    function() {
        ...
        function populateList(books) {
            ...
            books.forEach(book => {
                ...
                <tr>
                    ...
                    <button type="button" id="details" onclick="window.open('details.html','_blank')" > Details </button></td>
        ...
        // document.getElementById("details").onclick=function() {getdetails()};
...
function getdetails() {
    document.getElementById('details1').innerHTML+="hello";
}
